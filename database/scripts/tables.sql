...
CREATE TABLE public."persons" (
    "id" int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "company_id" int4 NULL, -- Referencia a la empresa a la que pertenece la persona.
...
CREATE TABLE public."company_registration_requests" (
    ...
    "approved_by" int4 NULL,  -- ID del usuario que aprobó/rechazó la solicitud
    "approved_at" timestamptz(0) NULL,  -- Fecha y hora de la aprobación/rechazo
...
COMMENT ON TABLE public."company_registration_requests"
IS 'Representa una solicitud de registro de empresa, realizada desde el módulo de registro.';
...
ALTER TABLE public."companies"
    ...
    ADD CONSTRAINT "companies_registration_requests_fk" FOREIGN KEY ("registration_request_id") REFERENCES public."company_registration_requests" ("id")
;

ALTER TABLE public."company_registration_requests"
    ADD CONSTRAINT "company_registration_requests_users_fk" FOREIGN KEY ("approved_by") REFERENCES public."users" ("id")
;
