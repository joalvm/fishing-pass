...
export default function Register({ className, ...props }: ComponentProps<'form'>) {
    return (
        <AuthLayout title="Registro" description="Registra tu empresa para comenzar a usar la aplicación">
